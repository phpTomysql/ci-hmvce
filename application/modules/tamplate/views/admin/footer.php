...
<![endif]-->
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/jquery-1.10.2.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/jquery.cokie.min.js" type="text/javascript"></script>
...
<!--<script src="<?php echo base_url(); ?>public/admin/assets/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>-->
<!--<script src="<?php echo base_url(); ?>public/admin/assets/plugins/jquery.pulsate.min.js" type="text/javascript"></script>-->
<script src="<?php echo base_url(); ?>public/admin/assets/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>public/admin/assets/scripts/core/app.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>public/admin/assets/scripts/custom/index.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>public/admin/assets/scripts/custom/tasks.js" type="text/javascript"></script>
